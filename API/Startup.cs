...
namespace API
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddTransient<IKhuvucBusiness, KhuvucBusiness>();
            services.AddTransient<IKhuvucRepository, KhuvucRepository>();
            services.AddTransient<IKhachhangBusiness, KhachhangBusiness>();
            services.AddTransient<IKhachhangRepository, KhachhangRepository>();
            services.AddTransient<IDatbanBusiness, DatbanBusiness>();
            services.AddTransient<IDatbanRepository, DatbanRepository>();
            services.AddTransient<IChucvuBusiness, ChucvuBusiness>();
            services.AddTransient<IChucvuRepository, ChucvuRepository>();
            services.AddTransient<IBanBusiness, BanBusiness>();
            services.AddTransient<IBanRepository, BanRepository>();
            services.AddTransient<IMonanBusiness, MonanBusiness>();
